 ...
 <table class="list" border="0" cellspacing="1" cellpadding="0" width="940">
    <thead>
        <tr>
            ...
            <th><a <?php echo $period_sort; ?> href="slas.php?<?php echo $qstr; ?>&sort=period"><?php echo __('Grace Period (days)');?></a></th>
            ...
            <tr id="<?php echo $id; ?>">
                ...
                <td>&nbsp;<?php 
                    if ($id = $sla->getAlertStaff()) {
                        if ($id[0] == 's' && ($staff=Staff::lookup(substr($id, 1)))) {
                            echo $staff->getName();
                        } elseif ($id[0] == 't' && ($team=Team::lookup(substr($id, 1)))) {
                            echo $team->getName();
                        }
                    }
                ?></td>
