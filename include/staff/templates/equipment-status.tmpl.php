...
if (!$info['title'])
    $info['title'] = __('Change Equipment Status');
...
$action = $info['action'] ?: ('#equipments/status/'. $state);

?>
<div id="equipment-status" style="display:block; margin:5px;">
...
$(function() {
    // Copy checked equipment to status form.
